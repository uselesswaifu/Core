package com.blademc.core.Cosmetic.FX;
    ...
    public void run() {
        ...
        for (int i = 0; i < particlesOrbital; ++i) {
            ...
            for (int j = 0; j < orbitals; ++j) {
                ...
                com.blademc.core.Cosmetic.FX.VectorUtils.rotateAroundAxisX(v, xRotation);
                com.blademc.core.Cosmetic.FX.VectorUtils.rotateAroundAxisY(v, rotation);
                //orbitalparticle
                location.getLevel().addParticle(new FlameParticle(location.add(v.x, v.y, v.z)));
                location.subtract(v.x, v.y, v.z);
            }
