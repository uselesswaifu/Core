package com.blademc.core.utils;
 ...
 */
public class CustomFloatingText extends Particle {
    ...
    public CustomFloatingText(Vector3 pos, String text) {
        this(pos, text, "");
    }

    public CustomFloatingText(Vector3 pos, String text, String title) {
